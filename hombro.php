...
<body class="bg-info">
	...
	<div class="container">
		...
		<div class="row mt-5">
			<div class="col-md-4">
				<div class="card">
					<img src="https://i.blogs.es/6485db/pres-hombro/1366_2000.webp" class="card-img-top"
						alt="Press de hombros con mancuernas">
					<div class="card-body">
			...
			<div class="col-md-4">
				<div class="card">
					<img src="https://i.blogs.es/7ad688/ejercicio21-3/1366_2000.webp" class="card-img-top"
						alt="Elevación lateral con mancuernas">
					<div class="card-body">
			...
			<div class="col-md-4">
				<div class="card">
					<img src="https://i.blogs.es/18b6f6/remo-cuello/1366_2000.webp" class="card-img-top"
						alt="Remo al mentón con barra">
					<div class="card-body">
		...
		<div class="row mt-5">
			<div class="col-md-4 offset-md-4">
				<div class="card">
					<img src="https://depowerlifting.site/wp-content/uploads/2021/06/press-frontal-de-hombros-en-maquina-sentado-y-agarre-neutro-1537.png"
						class="card-img-top" alt="Prensa de hombros en máquina">
					<div class="card-body">
